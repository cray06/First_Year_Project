...
static int isnt_delimiter(char c, const char *delimiters)
{
...
static int get_nb_word(char const *str, const char *delimiters)
{
    int nb = 0;
    int quote = 0;
    int can = 1;
...
static int get_number_char(char const *str, const char *delimiters, int i)
{
    int nb = 0;
    int quote = 0;
    int word_end = 0;
...
static char *put_str_temp(char const *str, const char *delimiters, int i)
{
    char *str_temp;
